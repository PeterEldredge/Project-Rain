...
namespace Aura2API
{
    ...
    public class AuraVolume : CullableObject
    {
        ...
        /// </summary>
        /// <param name="menuCommand">Data relative to the invoked menu</param>
        [MenuItem("GameObject/Aura 2/Volume/Global", false, 0)]
        ...
        /// </summary>
        /// <param name="menuCommand">Data relative to the invoked menu</param>
        [MenuItem("GameObject/Aura 2/Volume/Layer", false, 1)]
        ...
        /// </summary>
        /// <param name="menuCommand">Data relative to the invoked menu</param>
        [MenuItem("GameObject/Aura 2/Volume/Box", false, 2)]
        ...
        /// </summary>
        /// <param name="menuCommand">Data relative to the invoked menu</param>
        [MenuItem("GameObject/Aura 2/Volume/Sphere", false, 3)]
        ...
        /// </summary>
        /// <param name="menuCommand">Data relative to the invoked menu</param>
        [MenuItem("GameObject/Aura 2/Volume/Cylinder", false, 4)]
        ...
        /// </summary>
        /// <param name="menuCommand">Data relative to the invoked menu</param>
        [MenuItem("GameObject/Aura 2/Volume/Cone", false, 5)]
