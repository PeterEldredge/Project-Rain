...
namespace Opsive.UltimateCharacterController.FirstPersonController.Editor.Inspectors.Camera.ViewTypes
{
    /// <summary>
    /// Draws a custom inspector for the First Person View Type.
    /// </summary>
    [InspectorDrawer(typeof(FirstPerson))]
    public class FirstPersonInspectorDrawer : InspectorDrawer
    {
        /// <summary>
        ...
        public override void OnInspectorGUI(object target, Object parent)
        {
            ...
            if (InspectorUtility.Foldout(target, "Head Offset")) {
                EditorGUI.indentLevel++;
