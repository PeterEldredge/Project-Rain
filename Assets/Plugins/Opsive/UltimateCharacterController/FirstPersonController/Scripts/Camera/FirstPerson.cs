...
namespace Opsive.UltimateCharacterController.FirstPersonController.Camera.ViewTypes
{
    ...
    public abstract class FirstPerson : ViewType
    {
        ...
        public override void Initialize(CameraController cameraController)
        {
            ...
            EventHandler.RegisterEvent<ViewType, bool>(m_GameObject, "OnChangeViewTypes", OnChangeViewType);
        }
        ...
        private void UpdatePlatformRotationOffset(Transform platform)
        {
            ...
            if (!m_CharacterLocomotion.AlignToGround) {
        ...
        public Vector3 GetTargetPosition()
        {
            ...
            targetPosition += UpdateHeadOffset();

            return targetPosition;
        }

        /// <summary>
        /// Updates the head offset to match the current animator head position. Returns the smoothed head offset.
        /// </summary>
        /// <returns>The smooth head offset.</returns>
        private Vector3 UpdateHeadOffset()
        {
        ...
        public override void OnDestroy()
        {
            ...
            EventHandler.UnregisterEvent<ViewType, bool>(m_GameObject, "OnChangeViewTypes", OnChangeViewType);
        }
    }
}
