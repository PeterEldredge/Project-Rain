        ...
        private void UpdateLean(bool forceUpdate)
        {
            ...
            if (m_Collider != null) {
                ...
                if (m_Collider is CapsuleCollider) {
                    ...
                    hitCount = Physics.OverlapCapsuleNonAlloc(startEndCap, endEndCap, capsuleCollider.radius, m_OverlapColliders, m_LayerManager.SolidObjectLayers, QueryTriggerInteraction.Ignore);
                } else { // SphereCollider.
                    var sphereCollider = m_Collider as SphereCollider;
                    hitCount = Physics.OverlapSphereNonAlloc(m_ColliderTransform.TransformPoint(sphereCollider.center), sphereCollider.radius, m_OverlapColliders, m_LayerManager.SolidObjectLayers, QueryTriggerInteraction.Ignore);
                }
